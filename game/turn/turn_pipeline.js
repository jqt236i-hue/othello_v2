...
(function (root, factory) {
     ...
     * - action: { type: 'place' | 'pass' | 'use_card' | 'cancel_card', row?, col?, useCardId?, useCardOwnerKey?, debugOptions?, cancelOptions?, destroyTarget?: {row:number,col:number}, temptTarget?, inheritTarget? }
